...
for i = 1:length(testsets)
    ...
    ode(RK4, F,y0,tsteps,tout=tout)
    gc()
    print("RK4:        ")
    @time tout,yout = ode(RK4, F, y0, tsteps,tout=tout)
